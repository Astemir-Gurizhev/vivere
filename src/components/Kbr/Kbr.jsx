    ...
    return (
        <div className="kbr">
                <div className="container">
                    ...
                    <span>Кабарди́но-черке́сский или восто́чно-ады́гский язы́к (самоназвание — адыгэбзэ) </span> — язык кабардинцев и черкесов, один из государственных языков Кабардино-Балкарской и Карачаево-Черкесской республик.
